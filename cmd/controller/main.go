...
import (
	...
	svctypes "github.com/aws-controllers-k8s/opensearchservice-controller/apis/v1alpha1"
...
var (
	awsServiceAPIGroup    = "opensearchservice.services.k8s.aws"
	awsServiceAlias       = "opensearchservice"
