...
const (
	FinalizerString = "finalizers.opensearchservice.services.k8s.aws/Domain"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("domains")
