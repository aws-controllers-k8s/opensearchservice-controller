...
const (
	FinalizerString = "finalizers.opensearchservice.services.k8s.aws/VPCEndpointAccess"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vpcendpointaccesses")
	GroupKind            = metav1.GroupKind{
		Group: "opensearchservice.services.k8s.aws",
		Kind:  "VPCEndpointAccess",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VPCEndpointAccess{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCEndpointAccess),
	}
}
