...
// +kubebuilder:rbac:groups=opensearchservice.services.k8s.aws,resources=vpcendpointaccesses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchservice.services.k8s.aws,resources=vpcendpointaccesses/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"ServiceOptions", "SupportedRegions"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.ServiceOptions != nil && latestKo.Spec.ServiceOptions == nil {
		latestKo.Spec.ServiceOptions = observedKo.Spec.ServiceOptions
	}
	if observedKo.Spec.ServiceOptions != nil && latestKo.Spec.ServiceOptions != nil {
		if observedKo.Spec.ServiceOptions.SupportedRegions != nil && latestKo.Spec.ServiceOptions.SupportedRegions == nil {
			latestKo.Spec.ServiceOptions.SupportedRegions = observedKo.Spec.ServiceOptions.SupportedRegions
		}
	}
