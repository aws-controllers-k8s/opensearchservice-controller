...
// +kubebuilder:rbac:groups=opensearchservice.services.k8s.aws,resources=vpcendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opensearchservice.services.k8s.aws,resources=vpcendpoints/status,verbs=get;update;patch
