...
const (
	FinalizerString = "finalizers.opensearchservice.services.k8s.aws/VPCEndpoint"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vpcendpoints")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VPCEndpoint{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCEndpoint),
	}
}
